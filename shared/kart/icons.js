...
(function () {
  ...
  var ITEMS = {
    ...
    banana: '<path d="M16 14c2 22 15 34 36 27-8 14-27 18-38 4C5 34 7 21 16 14z" fill="#ffcf3f" ' + S + '/><path d="M15 14l-2-6M52 41l5 3" fill="none" ' + S + '/>',
    nitro: '<rect x="10" y="12" width="44" height="42" rx="5" fill="#ff6a5c" ' + S + '/><path d="M16 18h32v30H16z" fill="#2a2250"/><text x="32" y="40" text-anchor="middle" font-size="24" font-family="monospace" font-weight="bold" fill="#ffcf3f">N</text>',
    clock: '<circle cx="32" cy="34" r="23" fill="#fff6e3" ' + S + '/><path d="M32 34V19M32 34l12 7" fill="none" ' + S + ' stroke-width="6"/><path d="M20 8h24" ' + S + '/>',
